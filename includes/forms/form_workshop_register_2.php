<?php
	...
	//Listado de talleres
	$resultTalleres = $db->callProcedure("CALL ed_sp_web_taller_obtener_listado_2(".$_SESSION["id_idioma"].")");
	...
	$plantillaFormulario->assign("FORM_GDPR_NOTE",STATIC_FORM_MEMBERSHIP_PRIVACY_NOTE);
	$plantillaFormulario->assign("SISTER_ASSOCIATION_TEXT",STATIC_FORM_WORKSHOP_REGISTER_SISTER_ASSOCIATION_MEMBERSHIP_TEXT_2);
...
$eventoAsociaciones="";
	...
	$plantillaFormulario->assign("COMBO_ASOCIACIONES", generalUtils::construirCombo($db, "CALL ed_sp_web_asociacion_hermana_obtener_combo_2()", "cmbAsociacionHermana", "cmbAsociacionHermana", -1, "descripcion", "id_asociacion_hermana", STATIC_GLOBAL_COMBO_DEFAULT, -1, 'class="form-control" style="color:slategray;"',$eventoAsociaciones));
