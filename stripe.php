...
$subPlantilla = new XTemplate("html/stripe.html");

/**
 * Asignamos el CSS que corresponde a este apartado
 */
$plantilla->assign("SECTION_FILE_CSS", "stripe.css");
...
$breadCrumbDescripcionDetalle = "stripe_payment";
/**** FINAL: breadcrumb ****/
...
$plantilla->parse("contenido_principal.validate_stripe_payment");
