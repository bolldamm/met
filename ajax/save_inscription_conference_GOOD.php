...
/**
 *
 * This script validates the form data and inserts an error message in the registration form where necessary
 * If all is OK, it creates a new signup in ed_tb_inscripcion_conferencia and inserts the signup data
 * If the payment method is Paypal, it encrypts and posts the necessary data to Paypal
 * This includes the URL of the script to receive the reply (last_step_inscription_conference_paypal.php)
 *
 */
