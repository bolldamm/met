...
//Get billing details
$_POST["txtFacturacionNifCliente"] = generalUtils::escaparCadena(generalUtils::skipPlaceHolder(STATIC_FORM_PROFILE_BILLING_TAX_ID_NUMBER, $_POST["txtFacturacionNifCliente"]));
