(function (A) {
    A.extend(A.fn, {
        pstrength: function (B) {
            var B = A.extend({
            	minCharText: "Demasiado corta",
                verdects: ["Muy débil", "Débil", "Medio", "Fuerte", "Muy fuerte"],
                colors: ["#f00", "#c06", "#f60", "#3c0", "green"],
                scores: [10, 15, 30, 40],
        ...
        checkPassword: function (C, B) {
            ...
            //Compruebo si esta vacia la pass
            if(C.length==0){
            	F=-1
            }
