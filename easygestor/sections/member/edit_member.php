<?php
	...
	if(count($_POST)){
		...
		//Validamos internamente que realmente no esté el correo insertado
		...
		if($db->getNumberRows($resultado)==0){
			...
			//Guardar inscripciones pagamiento
			...
			//Actualizamos imagen, si se requiere...
	...
	if($idModalidadUsuario==MODALIDAD_USUARIO_INDIVIDUAL){
		...
		//Somos institucion
		//Mostramos los usuarios nominee
