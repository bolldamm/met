...
Hasta."','".$keyword."','".$campoOrden."','".$direccionOrden."',";
	...
	while($dato=$db->getData($resultado)){
        ...
        $encodedTo = rawurlencode($dato["email"]);
        $subject = rawurlencode($dato["asunto"]);
        $body = rawurlencode($dato["cuerpo"]);
        $vectorHistoryEmail["SUBJECT"]="<a href='mailto:".$encodedTo."?subject=".$subject."' target='_blank'>".$dato["asunto"]."</a>";
		//$vectorHistoryEmail["SUBJECT"]="<a href='mailto:".$encodedTo."?subject=".$subject."&body=".$body."' target='_blank'>".$dato["asunto"]."</a>";
		//$vectorHistoryEmail["SUBJECT"]=$dato["asunto"];
