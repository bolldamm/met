<?php
	...
	if($_GET["txtKeywords"]!=""){
			...
			$filtroPaginador.="&txtKeywords=".$_GET["txtKeywords"];
		}
	...
	$urlActual="main_app.php?section=eletter&action=view&hdnOrden=".$valorDefecto."&hdnRegistros=".$numeroRegistrosPagina."&";
