<?php
	...
	if(count($_POST)){
		//Inserto novedad
		$db->callProcedure("CALL ".OBJECT_DB_ACRONYM."_sp_novedad_insertar('".generalUtils::escaparCadena($_POST["txtNombre"])."','".generalUtils::escaparCadena($_POST["txtaDescripcion"])."')");
