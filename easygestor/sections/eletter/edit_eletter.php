<?php
	...
	if(count($_POST)){
		$db->callProcedure("CALL ".OBJECT_DB_ACRONYM."_sp_novedad_editar(".$_POST["hdnIdEletter"].",'".generalUtils::escaparCadena($_POST["txtNombre"])."','".generalUtils::escaparCadena($_POST["txtaDescripcion"])."')");
