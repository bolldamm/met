<?php
	//define("CURRENT_DOMAIN","http://".$_SERVER["HTTP_HOST"]);
	define("CURRENT_DOMAIN","http://www.metmeetings.org/");
	...
	define("WIDTH_SIZE_MENU_HEADER",791);
	define("HEIGHT_SIZE_MENU_HEADER",137);
	...
	define("WIDTH_SIZE_ACCESS_BUTTON",200);
	define("HEIGHT_SIZE_ACCESS_BUTTON",200);
