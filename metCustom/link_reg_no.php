...
//  echo $_GET["movement"];
  ...
  $codeProcedure="CALL ".OBJECT_DB_ACRONYM."_pr_link_to_reg_id_via_member_no('".$_GET["movement"]."','".$_GET["regno"]."')";
...
<h1>Link Reg ID number</h1>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="get">
    ...
    <label for="registration_id">Member ID</label>&nbsp;&nbsp;<input style="width:50px" name="regno" type="number" value="" />&nbsp;&nbsp;
